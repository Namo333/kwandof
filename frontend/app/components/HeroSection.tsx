...
const HeroSection: React.FC = () => {
  return (
    <section className="flex mt-[50px] flex-col gap-20">
      <div className="flex justify-between max-md:justify-center max-md:text-center">
        ...
        <div className="relative -ml-[400px] z-0 max-md:hidden">
          <Image
              src='/img/bg2.svg'
              alt="bg"
      ...
      <div className="">
        <div className="bg-foreground w-full h-[150px] max-[640px]:h-[320px] rounded-[16px] flex items-center justify-evenly text-white flex-col sm:flex-row">
